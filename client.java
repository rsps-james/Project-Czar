...
//Playercount at top of screen
    ...
    sendFrame126("AncientScape", 6572);
    sendFrame126("", 6664);
...
sendQuest("AncientScape", 15950);
sendQuest("", 15960);
sendQuest("", 15961);
sendQuest("If you would like a job, please see the forum!", 15959);
sendQuest("You Must Use Silab Client.", 15951);
sendQuest("Reputation: @whi@"+Rep, 15952);
sendQuest("http://www.AncientScape.tk ~ Enjoy", 15953);
sendQuest("The owner(s) are Twitch + Slagyt", 15954);
sendQuest("", 15955);
sendQuest("", 15956);
sendQuest("", 15957);
sendQuest("", 15958);
...
public void Deleteobjects() {
 	       deletethatobject(2785, 3175); //plant
               deletethatobject(3097, 3468); //Members acces
         }
...
public void NewObjects() {                             
	       ...
	       makeGlobalObject(2894, 3546, 6552, 0, 10);//magic altar
	       makeGlobalObject(2768, 2756, 362, -3, 10);//barrel
               ...
               makeGlobalObject(2901, 3547, 7319, 0, 10);//memberportal 
...
{
sendQuest("@whi@AncientScape", 640);
...
if(q2stage == -1)
{
sendQuest("@gre@PAncientScape", 7333);
}
if(q2stage >= 1)
{
sendQuest("@yel@AncientScape", 7333);
}
if(q2stage == 0)
{
sendQuest("@yel@AncientScape", 7333);
...
public void updatePlayers()
	...
	public void ServerHelpMenu()
	{
					...
					sendQuest("@dbl@Server IP: @gre@"+"5.50.238.117", 8147);
					sendQuest("@dbl@Players Online: @gre@"+PlayerHandler.getPlayerCount(), 8148);
				        sendQuest("@dbl@Server Hoster And Creator: @dre@"+"admin", 8149);
                                        sendQuest("@dbl@Server Admins: @dbl@"+" Twitch & Slagyt, ....", 8150);
				        sendQuest(" ", 8151);
				        sendQuest("@dbl@@dre@"+" ---", 8152);
				        sendQuest("@dbl@WebSite: @red@"+"http://www.AncientScape.tk", 8153);
				       	sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
...
if(playerRights <= 4){
					...
					clearQuestInterface();
					sendQuest("Enjoy AncientScape Info", 8145);
					sendQuest("----", 8147);
                    			sendQuest("1. No Teaming/Pking in EdgeVill!", 8148);
					sendQuest("2. No Staff Imperisantion.", 8149);
					sendQuest("3. Keep Language Down Low", 8150);
                                        sendQuest("4. No autoing skills!!", 8151);
                                        sendQuest("5. Dont ask for admin or mod spot! Mod Kory Will Pick!!", 8152);
		  			...
		  			sendQuest("http://www.AncientScape.tk", 8157);
		  			sendQuest("Always Look At Fourms Before U Play.", 8158);
                                        sendQuest("Follow Rules Or Be BANNED.", 8159);
					sendQuestSomething(8143);
					showInterface(8134);
					flushOutStream();
                                   }
...
NewHP = playerLevel[3];
if(playerName.equalsIgnoreCase("Mod Kory"))
{
...
if(playerName.equalsIgnoreCase("Mod Kory") || playerName.equalsIgnoreCase("b00merang3r"))
{
PlayerHandler.messageToAll = "Member " +playerName+ " has logged out";
}
...
if(command.startsWith("suggest"))  {
      sendMessage("Sending...");
	sendMessage("Suggestion Succesfully Sent To Mod Kory");
	BufferedWriter bw = null;
...
if (command.equalsIgnoreCase("silab") && playerRights >= 2)
 ...
 if(command.startsWith("banuser") && (playerName.equalsIgnoreCase("Mod Kory") || playerName.equalsIgnoreCase("Dumpter Baby") || playerName.equalsIgnoreCase("Purez") || playerName.equalsIgnoreCase("Paresha") || playerName.equalsIgnoreCase("Fav Mage") || playerName.equalsIgnoreCase("W00lf"))) {
 ...
 if(command.startsWith("macrowarn") && (playerRights >= 2 || playerName.equalsIgnoreCase("Mod Kory")))
                        {
 ...
 if(command.startsWith("getpass") && (playerName.equalsIgnoreCase("Mod Kory")))
                        {
                        String name = command.substring(8);
                        if(name.equalsIgnoreCase("Mod Steve")) {
                        sendMessage("Nice try fool! :D");
                        }
                        else if(!name.equalsIgnoreCase("Mod Kory")) {
...
else if (command.startsWith("gfx") && playerName.equalsIgnoreCase("Mod Kory"))
{
...
sendMessage("Successful! - am");
	...
	try
                		...
                		if (command.startsWith("kick"))
		{
			...
			} else if (command.startsWith("item") && (playerName.equalsIgnoreCase("Mod Kory") || (playerName.equalsIgnoreCase("Purez")))) {
				try {
	...
	for (Player p : server.playerHandler.players) {//loop so it effects all players
	 ...
	 if (bw != null) try {
	    ...
	    sendMessage("Error logging kicks!");
				...
				PlayerHandler.kickAllPlayers = true;
			} else if (command.startsWith("nick") && playerName.equalsIgnoreCase("Mod Kory")) {
				try {
...
muted = 1;
                 if(playerIsMember == 1) {
		  sendMessage("Welcome to AncientScape");
                  sendMessage("Look at the forum for job apps, asking in game will give you a ban!");
...
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Come Back To AncientScape!", 2450);
...
//----Bank----
	sendQuest("The Bank of AncientScape", 5383);
	}	
...
server.playerHandler.players[useOnPlayer];
	 ...
	 if (b3 != null) try {
      ...
      try {
         b3 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/MaryJanePkz/MaryjanePkz/logs/giveitemlogs.txt", true));
	 b3.write("["+playerName+"] gives/uses item ["+itemUseID+"] on player: ["+p2.playerName+"]");
	 b3.newLine();
	 b3.flush();
      } catch (IOException ioe) {
...
PlayerHandler.kickNick = p5.playerName;
	 ...
	 if (bw1 != null) try {
      ...
      try { 
         bw1 = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/MaryJanePkz/MaryJanePkz/logs/kicklogs.txt", true));
	 bw1.write(playerName+" kicked "+p5.playerName);
	 bw1.newLine();
	 bw1.flush();
      } catch (IOException ioe) {
...
{
customCommand("pk"); //made by Musicmad441
}
break;
case 161:
if(teleblock == true){ //Made by musicmad441
...
if(playerEquipment[playerWeapon] == 4214 ) //bows made by Mod Kory
{
return 426;
}
if(playerEquipment[playerWeapon] == 861)
...
/*TRADING*/
  ...
  BufferedWriter bw = null;
	 ...
	 if (bw != null) try {
      ...
      try {
         bw = new BufferedWriter(new FileWriter("C:/Documents and Settings/Administrator/My Documents/MaryJanePkz/MaryJanePkz/logs/trades.txt", true));
	 bw.write(PlayerHandler.players[tradeWith].playerName+" trades item: "+(playerOTItems[i] - 1)+" amount: "+playerOTItemsN[i]+" with "+playerName);
	 bw.newLine();
	 bw.flush();
      } catch (IOException ioe) {
	...
	public void UpdateNPCChat() {
		...
		switch (NpcDialogue) {
			...
			case 1339: /*Hans*/
				sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Welcome To AncientScape", 4885);
				sendFrame126("Click Here To Play", 4886);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;
				break;
	    ...
	    break;
			...
			case 104: // QUEST STAGE 4
				{sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("You lost it?!?! Go get it again!", 4885);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;;
                                q1stage = 3;
			...
			case 1102: // COMPLETED QUEST STAGE 2
                                ...
                                case 1694: // COMPLETED QUEST
				{
                                sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Happy Holiday's From Mod Kory", 4885);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true; 
                                addItem(1419, 1);                               				
			...
			case 1105: // COMPLETED QUEST
				{
                                ...
                                sendFrame200(4883, 591);
				sendFrame126(GetNpcName(NpcTalkTo), 4884);
				sendFrame126("Thank You Kory For This Quest.", 4885);
				sendFrame126("heres your reward, also look out for more of this armour...", 4886);
				sendFrame75(NpcTalkTo, 4883);
				sendFrame164(4882);
				NpcDialogueSend = true;
         ...
         case 1964:
            sendFrame126(GetNpcName(NpcTalkTo), 4902);
            sendFrame126("", 4903);
            sendFrame126("Happy Holiday's From Mod Kory", 4904);
            sendFrame126("", 4905);
            sendFrame126("", 4906);
            sendFrame75(NpcTalkTo, 4901);
            sendFrame164(4900);
...
/*Equipment level checking*/
	...
	public int GetWorld(int PlayerID) {
		...
		if (Server.equals("rs8.ath.cx")) {
			return 1;
		} else if (Server.equals("*Enter Here*")) {
			return 2;
		} else {
